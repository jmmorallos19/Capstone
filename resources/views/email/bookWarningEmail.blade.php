...
<head>
    ...
    <title>Library Book Due Tomorrow - Warning Notice</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>This is a friendly reminder from <strong>ICC Library</strong> regarding the book(s) you borrowed. According to our records, the following item(s) are due for return tomorrow:</p>
        ...
        <p>We would like to kindly remind you that your borrowed book is due for return tomorrow. To avoid any overdue fines, we kindly ask that you return the book(s) by the due date.</p>

        <p>If you are unable to return the book(s) on time, please be advised that overdue fines will apply. To prevent any inconvenience, we suggest returning the books before the due date.</p>
